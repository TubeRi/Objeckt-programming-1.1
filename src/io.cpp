...
)
{
    ...
    if (!fin)
    {
        throw std::runtime_error(
            "Klaida: failas neegzistuoja arba nepavyko jo atidaryti."
        );
    }
...
void IsvestiIFaila(
    ...
    const std::vector<Student>& studentai
)
{
